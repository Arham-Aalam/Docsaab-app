...
/**
 * Created by Arham on 01/07/2018.
 */
...
public class SubCategoryAdapter extends RecyclerView.Adapter<SubCategoryAdapter.ViewHolder> {
                ...
                public void onClick(View v) {
                    ...
                    if(pos != RecyclerView.NO_POSITION) {
                        ...
                        if(pos >= 0 && pos < getItemCount()) {
                            ...
                            intent.putExtra("_ID", cat_ID);
                            intent.putExtra("CAT_ID", dataCursor.getInt(dataCursor.getColumnIndex(CategoryContract.CategoryEntry.SUB_ID)));
    ...
    public SubCategoryAdapter(Activity mContext, Cursor cursor) {
        dataCursor = cursor;
        context = mContext;
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull final SubCategoryAdapter.ViewHolder holder, int position) {
